...
<h3>🚀 Full-Stack Developer · ERP Architect · Data Engineer</h3>

<!-- Typing animation -->
<a href="https://git.io/typing-svg">
  <img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=20&pause=1000&color=A78BFA&center=true&vCenter=true&random=false&width=600&lines=Construindo+sistemas+que+escalam+%F0%9F%9A%80;ERP+%7C+Data+Engineering+%7C+Cloud+Native;C%23+%7C+Python+%7C+JavaScript+%7C+SQL+Server;Transformando+dados+em+decisoes+%F0%9F%8E%AF" alt="Typing SVG" />
</a>
...
const lucas = {
  ...
  location:   "Brasil 🇧🇷",
  focus:      ["ERP Systems", "Data Engineering", "Cloud Infrastructure"],
  currently:  "Desenvolvendo ERP enterprise do zero com módulos fiscais brasileiros",
  expertise:  ["NF-e / SEFAZ", "SQL Server", "Next.js", "C# / .NET", "Kubernetes"],
  passion:    "Transformar processos complexos em sistemas elegantes e escaláveis",
  goal:       "Senior CLT em empresa de tecnologia industrial 🎯"
};
```
...
|--------|-----------|-------------|
| 🏢 **GlobalPro ERP** | ERP enterprise com 8 módulos, fiscal brasileiro (NF-e/CBS/IBS Split Payment 2026) e multi-tenant | C# · .NET · SQL Server · Next.js |
| 🔍 **Visualizador de Dados** | Ferramenta interna de auditoria de master data com fuzzy matching e 9 abas de análise | Next.js · TypeScript · SQL Server |
| 🌐 **Infraestrutura de Rede** | Projeto dual-WAN (Starlink + fibra) com UniFi UDM-Pro e 5 APs para ambiente corporativo | Ubiquiti · UniFi · Starlink |
...
[![GitHub Streak](https://streak-stats.demolab.com/?user=lucasjpl1&theme=tokyonight&hide_border=true&background=0d1117&stroke=a78bfa&ring=a78bfa&fire=f97316&currStreakLabel=a78bfa)](https://git.io/streak-stats)
...
```
🏭  ERP & Sistemas Empresariais    ████████████████████  100%
🇧🇷  Fiscal Brasileiro (NF-e/SPED)  ██████████████████░░   90%
🗃️  Data Engineering & SQL Server  ██████████████████░░   90%
⚙️  Arquitetura de Software        █████████████████░░░   85%
☁️  Cloud & Infraestrutura         ████████████████░░░░   80%
🔐  IAM & Segurança (Keycloak)     ███████████████░░░░░   75%
```
...
<!-- Footer -->
<br/>
<img src="https://komarev.com/ghpvc/?username=lucasjpl1&label=Visitas+ao+perfil&color=a78bfa&style=flat" alt="profile views" />
<br/><br/>
<sub>⭐ Se algum projeto te ajudou, considera deixar uma estrela!</sub>
